const Home = () => {
	return (
		<div className='flex flex-col justify-center items-center overflow-x-hidden min-h-screen bg-slate-300 space-y-12'>
			<p className='text-5xl font-bold text-center py-6 px-12'>
			...
			<div className=''>
				...
				<div className='flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-12 px-6 lg:px-36 py-6'>
					...
					<div className='shadow-lg border-2 border-black rounded-xl px-12 py-6 space-y-2'>
						<p className='font-mono text-xl bg-slate-400 w-fit'>
							yarn run watch-tw
						</p>
						<p className='text-lg text-slate-600'>
